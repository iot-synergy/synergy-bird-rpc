...
var file_bird_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x61, 0x22, 0x4f, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6c, 0x65, 0x61, 0x6e, 0x52,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xba, 0x08, 0x0a, 0x04, 0x62, 0x69, 0x72, 0x64, 0x12, 0x3a,
	...
	0x73, 0x70, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x62, 0x69, 0x72, 0x64, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_bird_proto_depIdxs = []int32{
	...
	0,  // 16: bird.bird.publishIllustration:input_type -> bird.IdReq
	0,  // 17: bird.bird.unpublishIllustration:input_type -> bird.IdReq
	0,  // 18: bird.bird.deleteIllustration:input_type -> bird.IdReq
	14, // 19: bird.bird.labelCreate:input_type -> bird.LabelCreateReq
	15, // 20: bird.bird.labelUpdate:input_type -> bird.LabelUpdateReq
	16, // 21: bird.bird.labelList:input_type -> bird.LabelListReq
	16, // 22: bird.bird.findLabelByPage:input_type -> bird.LabelListReq
	0,  // 23: bird.bird.findLabelById:input_type -> bird.IdReq
	0,  // 24: bird.bird.publishLabel:input_type -> bird.IdReq
	0,  // 25: bird.bird.unpublishLabel:input_type -> bird.IdReq
	0,  // 26: bird.bird.deleteLabel:input_type -> bird.IdReq
	4,  // 27: bird.bird.galleryCreate:output_type -> bird.GalleryResp
	4,  // 28: bird.bird.galleryUpdate:output_type -> bird.GalleryResp
	5,  // 29: bird.bird.galleryList:output_type -> bird.GalleryListResp
	9,  // 30: bird.bird.illustrationCreate:output_type -> bird.IllustrationsResp
	9,  // 31: bird.bird.illustrationUpdate:output_type -> bird.IllustrationsResp
	11, // 32: bird.bird.illustrationList:output_type -> bird.IllustrationsListResp
	12, // 33: bird.bird.findIllustrationByPage:output_type -> bird.IllustrationsListVo
	9,  // 34: bird.bird.publishIllustration:output_type -> bird.IllustrationsResp
	9,  // 35: bird.bird.unpublishIllustration:output_type -> bird.IllustrationsResp
	22, // 36: bird.bird.deleteIllustration:output_type -> bird.BooleanResp
	17, // 37: bird.bird.labelCreate:output_type -> bird.LabelResp
	17, // 38: bird.bird.labelUpdate:output_type -> bird.LabelResp
	18, // 39: bird.bird.labelList:output_type -> bird.LabelListResp
	19, // 40: bird.bird.findLabelByPage:output_type -> bird.LabelListVo
	21, // 41: bird.bird.findLabelById:output_type -> bird.LabelVo
	17, // 42: bird.bird.publishLabel:output_type -> bird.LabelResp
	17, // 43: bird.bird.unpublishLabel:output_type -> bird.LabelResp
	22, // 44: bird.bird.deleteLabel:output_type -> bird.BooleanResp
